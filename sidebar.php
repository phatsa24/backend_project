                ...
                <div class="col-2">
                    <div class="content-left">
                        ...
                        <div class="wrap-center">
                            <img width="50px" src="assets/image/<?php echo $row['profile'] ?>" alt="">
                        ...
                        <div class="wrap-bottom">
                            <ul>
                                ...
                                <li class="parent">
                                    ...
                                    <ul class="child">
                                        <li>
                                            <a href="logo_add_post.php">logo add post</a>
                                            <a href="logo_view_post.php">logo view post</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="parent">
                                ...
                                <li class="parent">
                                    ...
                                    <ul class="child">
                                        <li>
                                            ...
                                            <a href="view_about_us.php">View about us</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="parent">
