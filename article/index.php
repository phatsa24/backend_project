                ...
                <div class="col-12">
                    <div class="content-trending">
                        ...
                        <div class="content-right" >
                            <marquee onmouseover="this.stop()" onmouseleave="this.start()" behavior="" direction="left">
                                <div class="text-news">    
                                    <?php get_trending_new() ?>
                                    <!-- <i class="fas fa-angle-double-right"></i>
                                    <a href="news-detail.php">ពិធីសម្ពោធដាក់ឱ្យប្រើប្រាស់នូវកំណាត់ផ្លូវជាតិលេខ២៦ ប្រវែងជិត ៦៤គីឡូម៉ែត្រ </a> &ensp;
                                    <i class="fas fa-angle-double-right"></i>
    ...
    <section class="news">
        <div class="container">
            <div class="row">
                ...
                <?php get_news_type("intertainment") ?>
            </div>
        </div>
    </section>
</main>
